package com.kondoumh.hellokafkastreamsbinder;
...
public class HelloKafkaStreamsBinderApplication {

	public static void main(String[] args) {
		SpringApplication.run(HelloKafkaStreamsBinderApplication.class, args);
	}
